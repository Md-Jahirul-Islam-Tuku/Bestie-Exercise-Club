...
const Activity = ({ activity }) => {
   ...
   return (
      <div>
         <div className="card w-96 min-h-full bg-zinc-900 shadow-xl border-2 border-gray-700">
            <figure><img className='h-60 w-full' src={picture} alt="Shoes" /></figure>
            <div className="card-body text-left">
               <h2 className="card-title text-3xl text-yellow-500">{name}</h2>
               <p>{description}</p>
               ...
               <div className="">
                  <button className="btn btn-info w-[100%]">Add To List</button>
               </div>
            </div>
         </div>
      </div>
